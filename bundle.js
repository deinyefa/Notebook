...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _reduxPersist = __webpack_require__(199);
	...
	var store = (0, _redux.compose)((0, _redux.applyMiddleware)(), (0, _reduxPersist.autoRehydrate)())(_redux.createStore)(_reducers2.default);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _isStatePlainEnough = __webpack_require__(202);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _asyncLocalStorage = __webpack_require__(214);
	...
	var _jsonStringifySafe = __webpack_require__(217);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _setImmediate = __webpack_require__(215);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _folderList = __webpack_require__(226);

	var _folderList2 = _interopRequireDefault(_folderList);

	var _noteList = __webpack_require__(227);

	var _noteList2 = _interopRequireDefault(_noteList);

	var _noteArea = __webpack_require__(228);

	var _noteArea2 = _interopRequireDefault(_noteArea);
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(_noteArea2.default, null)
					)
				);
			}
		}]);
...
/***/ (function(module, exports, __webpack_require__) {
		...
		_createClass(Header, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'h2',
						{ className: 'col-sm-12 heading text-center' },
						'Notebook'
					),
					_react2.default.createElement(
						'div',
						...
						_react2.default.createElement(
							'i',
							{ className: 'material-icons', onClick: this.props.removeNote },
							'\uE872'
						),
						_react2.default.createElement(
							'i',
							{
								...
								onClick: function onClick() {
									_this2.props.newNote(_this2.props.selectedFolder);
								}
							},
							'note_add'
						)
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'i',
							{ className: 'material-icons text-icon' },
							'font_download'
						)
					),
					_react2.default.createElement(
						...
						_react2.default.createElement('input', { className: 'material-icons searchbox', placeholder: 'search' })
					)
				);
			}
		}]);
	...
	function mapDispachToProps(dispatch) {
		return (0, _redux.bindActionCreators)({ newNote: _index.newNote, removeNote: _index.removeNote, toggleFolderList: _index.toggleFolderList }, dispatch);
	}

	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispachToProps)(Header);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.folderOptions = folderOptions;
	exports.newFolder = newFolder;
	exports.removeFolder = removeFolder;
	exports.renameFolder = renameFolder;
	exports.folderToRename = folderToRename;
	exports.toggleFolderList = toggleFolderList;

	var _notes_constants = __webpack_require__(224);

	var _folder_constants = __webpack_require__(225);

	// ------------------------------------ NOTES ACTIONS ------------------------------------- //
	function selectNote(note) {
		// selectNote is an action creator, needs to return an action - an object with a type property
		return {
			type: _notes_constants.NOTE_SELECTED,
			payload: note
		};
	}
	function updateContent(content) {
		return {
			type: _notes_constants.CONTENT_UPDATE,
			payload: content
		};
	}
	function newNote(folder) {
		return {
			type: _notes_constants.NEW_NOTE,
			payload: folder
		};
	}
	function removeNote() {
		return {
			type: _notes_constants.REMOVE_NOTE
		};
	}
	...
	function selectFolder(folder) {
		return {
			type: _folder_constants.FOLDER_SELECTED,
			payload: folder
		};
	}
	function folderOptions(folder) {
		return {
			type: _folder_constants.FOLDER_OPTIONS,
			payload: folder
		};
	}
	function newFolder() {
		return {
			type: _folder_constants.NEW_FOLDER
		};
	}
	function removeFolder() {
		return {
			type: _folder_constants.REMOVE_FOLDER
		};
	}
	function renameFolder(folder) {
		return {
			type: _folder_constants.RENAME_FOLDER,
			payload: folder
		};
	}
	function folderToRename(folder) {
		return {
			type: _folder_constants.FOLDER_TO_RENAME,
			payload: folder
		};
	}
	function toggleFolderList() {
		return {
			type: _folder_constants.TOGGLE_FOLDER_LIST
		};
	}
...
/***/ (function(module, exports) {
	...
	var NOTE_SELECTED = exports.NOTE_SELECTED = 'NOTE_SELECTED';
	var CONTENT_UPDATE = exports.CONTENT_UPDATE = 'CONTENT_UPDATE';
	var NEW_NOTE = exports.NEW_NOTE = 'NEW_NOTE';
...
/***/ (function(module, exports) {
	...
	var FOLDER_SELECTED = exports.FOLDER_SELECTED = 'FOLDER_SELECTED';
	var FOLDER_OPTIONS = exports.FOLDER_OPTIONS = 'FOLDER_OPTIONS';
	var NEW_FOLDER = exports.NEW_FOLDER = 'NEW_FOLDER';
	var REMOVE_FOLDER = exports.REMOVE_FOLDER = 'REMOVE_FOLDER';
	var FOLDER_TO_RENAME = exports.FOLDER_TO_RENAME = 'FOLDER_TO_RENAME';
	var RENAME_FOLDER = exports.RENAME_FOLDER = 'RENAME_FOLDER';
	var TOGGLE_FOLDER_LIST = exports.TOGGLE_FOLDER_LIST = 'TOGGLE_FOLDER_LIST';
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var FolderList = function (_Component) {
		_inherits(FolderList, _Component);
		...
		_createClass(FolderList, [{
			key: 'handleChange',
			value: function handleChange(folder, e) {
				...
				return this.props.folders.map(function (folder) {
					return _react2.default.createElement(
						'li',
						{
							...
							key: folder.id,
							onClick: function onClick() {
								return _this2.props.selectFolder(folder);
							},
							onContextMenu: function onContextMenu(e) {
								e.preventDefault();
								_this2.props.folderOptions(folder);
							}
						},
						folder.id == _this2.props.rightClickedIndex ? _react2.default.createElement(
							'select',
							{ onChange: _this2.handleChange.bind(_this2, folder) },
						...
						folder.id == _this2.props.indexToRename ? _react2.default.createElement(
							'form',
							{ onSubmit: _this2.handleSubmit },
							_react2.default.createElement('input', {
								type: 'text',
								value: folder.name,
								onChange: _this2.valueChange.bind(_this2)
							}),
							_react2.default.createElement('input', {
								type: 'submit',
								style: {
			...
			value: function render() {
				return _react2.default.createElement(
					'div',
					{
						className: 'folder col-sm-2 ' + (this.props.listShowing ? 'hidden' : 'show')
					},
					_react2.default.createElement(
						'ul',
						null,
					...
					_react2.default.createElement(
						'div',
						{ className: 'new_folder fixed-bottom' },
						_react2.default.createElement(
							'i',
							{ className: 'material-icons', onClick: this.props.newFolder },
							'add'
						),
						_react2.default.createElement(
							'p',
	...
	function mapDispachToProps(dispatch) {
		return (0, _redux.bindActionCreators)({
			selectFolder: _index.selectFolder,
			newFolder: _index.newFolder,
			folderOptions: _index.folderOptions,
			removeFolder: _index.removeFolder,
			folderToRename: _index.folderToRename,
			renameFolder: _index.renameFolder
		}, dispatch);
	}

	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispachToProps)(FolderList);
...
/***/ (function(module, exports, __webpack_require__) {
		...
		_createClass(NoteList, [{
			...
			value: function renderList() {
				...
				return this.props.notes.filter(function (note) {
					return note.folderid == _this2.props.selectedfolder.id;
				}).map(function (note) {
					return _react2.default.createElement(
						'li',
						{
							...
							key: note.id,
							onClick: function onClick() {
								return _this2.props.selectNote(note);
							}
						},
						note.title
					);
			...
			value: function render() {
				return _react2.default.createElement(
					'div',
					{ className: 'note-list col-sm-4 px-0' },
					_react2.default.createElement(
						'ul',
						null,
						this.renderList()
	...
	function mapDispachToProps(dispatch) {
		...
		return (0, _redux.bindActionCreators)({ selectNote: _index.selectNote }, dispatch);
	}
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispachToProps)(NoteList);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var NoteArea = function (_Component) {
		_inherits(NoteArea, _Component);

		function NoteArea() {
			_classCallCheck(this, NoteArea);

			return _possibleConstructorReturn(this, (NoteArea.__proto__ || Object.getPrototypeOf(NoteArea)).apply(this, arguments));
		}
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement('textarea', {
						...
						onChange: function onChange(e) {
							return _this2.props.content(e.target.value);
						}
					})
				);
			}
	...
	function mapDispachToProps(dispatch) {
		return (0, _redux.bindActionCreators)({ content: _index.updateContent }, dispatch);
	}

	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispachToProps)(NoteArea);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _reducer_folders = __webpack_require__(230);

	var _reducer_folders2 = _interopRequireDefault(_reducer_folders);

	var _reducer_notes = __webpack_require__(231);

	var _reducer_notes2 = _interopRequireDefault(_reducer_notes);

	var _reducer_persist = __webpack_require__(232);

	var _reducer_persist2 = _interopRequireDefault(_reducer_persist);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var rootReducer = (0, _redux.combineReducers)({
		notes: _reducer_notes2.default,
		folders: _reducer_folders2.default,
		persist: _reducer_persist2.default
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
		var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {
			selected: _extends({}, folderlist[0]),
		...
		switch (action.type) {
			case _folder_constants.FOLDER_SELECTED:
				return _extends({}, state, { selected: action.payload });

			case _folder_constants.NEW_FOLDER:
				folder_id += 1;
				return _extends({}, state, {
					folderlist: [].concat(_toConsumableArray(state.folderlist), [{ name: '', id: folder_id }])
				});

			case _folder_constants.FOLDER_OPTIONS:
				return _extends({}, state, {
					rightClickedIndex: action.payload.id
				});

			case _folder_constants.REMOVE_FOLDER:
				var folderIndex = state.folderlist.findIndex(function (element) {
					return element.id == state.rightClickedIndex;
				});
				...
				if (state.folderlist.length == 0) {
					folder_id = 1;
					return _extends({}, state, {
						folderlist: [].concat(_toConsumableArray(state.folderlist), [{ title: '', id: folder_id }]),
						selected: _extends({}, state.selected, { title: '' })
					});
				...
				return _extends({}, state, {
					folderlist: [].concat(_toConsumableArray(state.folderlist)),
					selected: nextSelected
				});

			case _folder_constants.FOLDER_TO_RENAME:
				return _extends({}, state, {
					indexToRename: action.payload.id
				});

			case _folder_constants.RENAME_FOLDER:
				state.folderlist[state.indexToRename].name = action.payload;
				return _extends({}, state, {
					folderlist: [].concat(folderlist)
				});

			case _folder_constants.TOGGLE_FOLDER_LIST:
	...
	var folderlist = [{ name: 'Folder 1', id: 0 }, { name: 'Folder 2', id: 1 }];
	var folder_id = 1;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
		var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {
			selected: {},
			notelist: [{ title: 'Grocery List', id: 1, folderid: 0 }, { title: 'Main Points', id: 2, folderid: 1 }, { title: 'Agenda', id: 3, folderid: 0 }, { title: 'Untitled', id: 4, folderid: 1 }]
		};
		var action = arguments[1];

		switch (action.type) {
			case _notes_constants.NOTE_SELECTED:
				return _extends({}, state, { selected: action.payload });
			case _notes_constants.CONTENT_UPDATE:
				return _extends({}, state, {
					notelist: state.notelist.map(function (note) {
						if (note.id == state.selected.id) note.title = action.payload;
						return note;
					}),
					selected: _extends({}, state.selected, { title: action.payload })
				});
			case _notes_constants.NEW_NOTE:
				nextID += 1;
				return _extends({}, state, {
					notelist: [].concat(_toConsumableArray(state.notelist), [{ title: '', id: nextID, folderid: action.payload.id }])
				});
			case _notes_constants.REMOVE_NOTE:
				var index = state.notelist.findIndex(function (element) {
					return element.id == state.selected.id;
				});
				...
				if (state.notelist.length == 0) {
					nextID = 1;
					return _extends({}, state, {
						notelist: [].concat(_toConsumableArray(state.notelist), [{ title: '', id: nextID }]),
						selected: _extends({}, state.selected, { title: '' })
					});
				} else if (index < state.notelist.length) newSelected = state.notelist[index];else {
					newSelected = state.notelist[index - 1];
				}

				return _extends({}, state, {
					notelist: [].concat(_toConsumableArray(state.notelist)),
